...
class KeyframesDataset(Dataset):
    def __init__(self, preprocess):
        self.PATH = "E:\\Downloads\\atm24949_2\\keyframes"
    ...
    def __getitem__(self, idx):
        ...
        return image, video_name, image_name, int(frame_idx), self.images_paths[idx].split('\\', 3)[3]
...
if __name__ == '__main__':
    ...
    dataset = KeyframesDataset(preprocess)
    dataloader = DataLoader(dataset, batch_size=128, shuffle=False, num_workers=6, persistent_workers=True)
    ...
    TABLE_NAME = "patch14v2_extended_openclip_batch2"
